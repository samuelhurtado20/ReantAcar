    ...
    public partial class SoftDelete : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "00000000-0000-0000-0000-000000000000", 0, "20d790a8-b9fa-4cc1-ac5d-4252faf24e78", "systemadmin@gmail.com", true, false, null, "systemadmin@gmail.com", "System Administrator", "AQAAAAIAAYagAAAAEI48sge81T84AiL2b2glnV4MsUodESEZRY/jE64yUttZaNJrsnSXYKvt+SbLz/KCoQ==", null, false, "", false, "SystemAdmin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "00000000-0000-0000-0000-000000000001", "00000000-0000-0000-0000-000000000000" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { "00000000-0000-0000-0000-000000000001", "00000000-0000-0000-0000-000000000000" });
